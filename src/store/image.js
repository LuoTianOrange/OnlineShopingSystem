export default [
    {
        ...
        desc:[//商品描述
            {
                no:1,
                text: `※商品画像はイメージです。実際のものとは若干異なる場合がございます。`
            },
            {
                no:2,
                text: `※お客様がご利用の画面の設定及び特性により、実際のアイテムと比較し色味に若干の誤差が生じる場合がございます。予めご了承ください。`
            },
            {
                no:2,
                text: `※注文内容や商品状態等により注文の取消し・返品をお受けできない場合がございます。`
            },
        ],
    },
    {
